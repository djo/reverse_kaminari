...
I tried to implement it without extending/hacking kaminari. See {specs}[https://github.com/Djo/reverse_kaminari/tree/master/spec/requests/cities_spec.rb/].

== Links

  * {Demo}[http://reverse-kaminari.heroku.com/]
  * {will_paginate case}[http://reverse-kaminari.heroku.com/]
